          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-12 gap-y-10">
            {[
              ...
              },
              {
                ...
                detail: 'Cell signaling enhancement using exosome technology.'
              },
              {
              ...
              },
              {
                ...
                icon: <Target size={16} />,
                detail: 'Personalized growth factor therapies for optimal healing.'
              }
            ].map((item, i) => (
              <div key={i} className="space-y-3">
                ...
                <p className="text-sm text-slate-400 font-medium leading-relaxed hover:text-slate-600 transition-colors">
                  {item.detail}
                </p>
              </div>
            ))}
        ...
        <div className="lg:col-span-6 bg-[#080808] relative min-h-[600px] flex items-center justify-center p-6 md:p-12 lg:p-20">
          ...
          <div className="relative w-full max-w-lg aspect-[4/5] group">
            <div className="absolute inset-0 bg-[#111] rounded-[2.5rem] border border-white/5 overflow-hidden shadow-[0_50px_100px_-30px_rgba(0,0,0,0.5)]">
              ...
              {/* FULL BRIGHT IMAGE */}
              <img
                src="/Gemini_Generated_Image_thorr3thorr3thor.png"
              ...
              <div className="absolute top-8 left-8 right-8 flex justify-between items-start z-20">
                <div>
                  <p className="text-[10px] font-mono text-[#A69D89] uppercase tracking-widest">
                    Analysis: REG-MED_03
                  </p>
                  <p className="text-[8px] font-mono text-white/30 uppercase tracking-widest">
                    Target: Cellular Regeneration
                  </p>
                </div>
                ...
                <div className="flex justify-between items-end border-t border-white/10 pt-4">
                  <div>
                    ...
                    <p className="text-xl font-mono text-white">
                      0.978 <span className="text-[#A69D89] text-[10px]">+7.8%</span>
                    </p>
                  </div>
            ...
            <div className="absolute -bottom-4 -left-4 bg-white p-6 shadow-2xl rounded-2xl hidden md:block max-w-[180px] border border-slate-50">
              ...
              <p className="text-[10px] font-medium text-slate-600">
                Protocols utilize <span className="font-bold text-black">cutting-edge biologics</span> for tissue regeneration.
              </p>
            </div>
          </div>
        </div>
