        ...
        <div className="lg:col-span-6 px-6 sm:px-10 md:px-16 py-16 lg:py-24 flex flex-col justify-center space-y-16">
          <div className="space-y-8">
            <div className="flex items-center gap-3">
              ...
              <span className="text-[10px] font-black uppercase tracking-[0.4em] text-[#A69D89]">Cellular Repair</span>
            </div>
            <h1 className="text-7xl md:text-8xl lg:text-9xl font-serif leading-[0.8] tracking-tighter">
              Regenerative <br />
              <span className="italic font-light text-slate-300">Medicine.</span>
            </h1>
            <p className="text-xl md:text-2xl text-slate-400 font-light italic leading-relaxed max-w-md border-l border-slate-100 pl-8">
              "We harness the body’s innate ability to repair and regenerate at the cellular level."
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-12 gap-y-10">
            {[
              { 
                title: "NAD+ Therapy", 
                icon: <Zap size={16} />,
                detail: "Boosting cellular energy and repair through advanced NAD+ protocols." 
              },
              { 
                title: "Exosome Delivery", 
                icon: <Activity size={16} />,
                detail: "Cell signaling enhancement for tissue regeneration using exosome technology." 
              },
              { 
                title: "Organ-Specific Protocols", 
                icon: <Microscope size={16} />,
                detail: "Targeted interventions for heart, liver, and neural tissue repair." 
              },
              { 
                title: "Growth Factor Modulation", 
                icon: <Target size={16} />,
                detail: "Personalized growth factor therapies for optimal healing and rejuvenation." 
              }
            ].map((item, i) => (
          ...
          <div className="relative w-full max-w-lg aspect-[4/5] group">
            <div className="absolute inset-0 bg-[#111] rounded-[2.5rem] border border-white/5 overflow-hidden shadow-[0_50px_100px_-30px_rgba(0,0,0,0.5)]">
              ...
              <div className="absolute top-8 left-8 right-8 flex justify-between items-start">
                <div className="space-y-1">
                  <p className="text-[10px] font-mono text-[#A69D89] font-bold tracking-widest uppercase">Analysis: REG-MED_03</p>
                  <p className="text-[8px] font-mono text-white/30 tracking-widest uppercase">Target: Cellular Regeneration</p>
                </div>
              ...
              <div className="absolute bottom-8 left-8 right-8">
                 <div className="flex justify-between items-end border-t border-white/10 pt-4">
                    <div className="space-y-1">
                      <span className="text-[8px] font-black text-white/20 uppercase tracking-[0.3em]">Repair Index</span>
                      <p className="text-xl font-mono text-white tracking-tighter">0.978 <span className="text-[10px] text-[#A69D89]">+7.8%</span></p>
                    </div>
                    <div className="h-8 w-24 flex items-end gap-1">
                      {[70, 90, 65, 100, 85, 95].map((h, i) => (
            ...
            <div className="absolute -bottom-4 -left-4 bg-white p-6 shadow-2xl rounded-2xl hidden md:block max-w-[180px] border border-slate-50">
              ...
              <p className="text-[10px] leading-relaxed font-medium text-slate-600">
                Protocols utilize <span className="text-black font-bold">cutting-edge biologics</span> for tissue regeneration.
              </p>
            </div>
          </div>
        </div>
